...
var _this = {
    ...
    loginClient:function(username, csessid, ts, actiontimestamp, cb){
        var srv = _this.dbWrapper.servers.find({"$and":[
            {"loggedIn":true},
            {"mysessid":{"$ne":null}}
        ]});
                ...
                request:{
                    ...
                    "param":[{
                        "$":{
                            "username":username,
                            "timestamp":ts,
                            "actiontimestamp":actiontimestamp[0]+"::"+actiontimestamp[1],
                            "csessid":csessid,
    ...
    registerClient:function(username, hash, timestamp, cb){
        var srv = _this.dbWrapper.servers.find({"$and":[
            {"loggedIn":true},
            {"mysessid":{"$ne":null}}
        ]});
