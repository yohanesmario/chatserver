...
s2sClient.probeHooks(cfg, function(connected){
    if (connected===true) {
        cfg.config.persistDB = false;
        cfg.persistDB = false;
        logWrapper.log("Not the first one in this chat network. Discarding database...");
    } else {
        cfg.config.persistDB = true;
        cfg.persistDB = true;
        logWrapper.log("First server in this chat network. Loading backup database...");
    }
